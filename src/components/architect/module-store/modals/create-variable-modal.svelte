<script lang="ts">
  ...
  const confirmNewVariable = () : void => {
    currentBop.variables.update(vars => {
      vars.push({ name: get(name), type: get(type), initialValue: get(value) } as BopsVariable);
      return vars;
    });
...
<div class="flex flex-row justify-between">
  <div class="text-white font-bold text-lg"> Create New Variable </div>
