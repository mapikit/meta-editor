...
<section class="w-full top-0 bg-norbalt-400 h-12 flex items-center fixed"> <!-- HEADER (TOPBAR) -->
  <div class="w-12 h-full flex items-center justify-center">
    <button class="w-10 h-7 ml-1" on:click={() => navigation.navigateTo("/")}> <!-- Icon holder-->
